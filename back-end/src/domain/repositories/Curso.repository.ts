...
export abstract class CursoRepository {
  abstract save(linha: CursoProps): Promise<any>;
  abstract findById(id: number): Promise<CursoProps>;
  abstract findByCpf(professorOrientadorCpf: string): Promise<CursoProps>;
  abstract delete(id: number): Promise<void>;
  abstract update(id: number, linha: CursoProps): Promise<void>;
